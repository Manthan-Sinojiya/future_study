...
if (isset($_GET['video_id'])) {
    ...
    echo "<script>window.location.href ='manage-videos.php'</script>";
}
                        ...
                        <div class="row breadcrumb-div">
                            <div class="col-md-6">
                                <ul class="breadcrumb">
                                    ...
                                    <li>Manage Video Lectures</li>
                                    <li class="active">View Video Lectures</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="panel-body p-20">
                                            <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT v.video_id, v.video_title, v.description, s.sub_name, m.module_name, v.topic_name, v.topic_number 
                                                    FROM videos v
                                                    ...
                                                    if ($query->rowCount() > 0) {
                                                        foreach ($results as $result) { ?>
                                                            <tr>
                                                                ...
                                                                <td><?php echo htmlentities($result->topic_number); ?></td>
                                                                <td>
                                                                    <a href="manage-videos.php?video_id=<?php echo htmlentities($result->video_id); ?>" onclick="return confirm('Do you really want to delete this video lecture?');">
